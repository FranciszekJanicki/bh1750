...
static bh1750_err_t bh1750_bus_transmit(bh1750_t const *bh1750,
  ...
  return bh1750->interface.bus_transmit
             ? bh1750->interface.bus_transmit(bh1750->interface.bus_user, data,
                                              data_size)
             : BH1750_ERR_NULL;
}

static bh1750_err_t bh1750_bus_receive(bh1750_t const *bh1750, uint8_t *data,
                                       size_t data_size) {
  return bh1750->interface.bus_receive
             ? bh1750->interface.bus_receive(bh1750->interface.bus_user, data,
                                             data_size)
             : BH1750_ERR_NULL;
}

bh1750_err_t bh1750_initialize(bh1750_t *bh1750, bh1750_config_t const *config,
...
bh1750_err_t bh1750_get_light_data_scaled(bh1750_t const *bh1750,
                                          float32_t *scaled) {
  ...
  *scaled =
      bh1750_raw_to_scaled(raw, bh1750->config.mode, bh1750->config.mtreg);
