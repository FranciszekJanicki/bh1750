...
static bh1750_err_t bh1750_bus_init(bh1750_t const* bh1750)
{
    return bh1750->interface.bus_init ? bh1750->interface.bus_init(bh1750->interface.bus_user)
                                      : BH1750_ERR_NULL;
}

static bh1750_err_t bh1750_bus_deinit(bh1750_t const* bh1750)
{
    return bh1750->interface.bus_deinit ? bh1750->interface.bus_deinit(bh1750->interface.bus_user)
                                        : BH1750_ERR_NULL;
}
...
bh1750_err_t bh1750_deinitialize(bh1750_t* bh1750)
{
    ...
    bh1750_err_t err = bh1750_bus_deinit(bh1750);
